...
collision_engine.Relaxation_pars(omega_e=omega_e,omega_v=omega_v)#MRT

#==============================================
stream_engine=openLBM.StreamEngine()

#==============================================
balls=openIBM.Sphere(1e3,50)

#==============================================
MDFIteration=1
ibm_engine=openIBM.IBEngine(MDFIteration=MDFIteration)
#==============================================
ib_dem_coupler_engine=openIBM.IBDEMCouplerEngine()
...
# for i in range (10):
    for j in range(20):
        ...
        ib_dem_coupler_engine.SphereUpdata(balls,pos_np,vel_np,angle_np)
        ib_dem_coupler_engine.SphereIBUpdate(balls)
        ...
        ibm_engine.MultiDirectForcingLoop(balls,lb_field)
        ibm_engine.ComputeParticleForce(balls)
