...
rho_cr_real= 2.6573041587
p_cr_real=0.2680404995
T_cr_real= 0.3281356673

rho_cr_LB= 2.6573041587
p_cr_LB=0.2680404995
T_cr_LB=0.3281356673
...
Tr=0.95
rho_liq=4.92866082300000
rho_gas=1.01290450300000
...
sc_engine = openLBDEM.ShanChenForceC1(
    ...
    psi=openLBDEM.PR_psi(params=PR_params),  # 将参数封装到字典中
    g_coh=gcoh,
...
def init_hydro():
    ...
    for m in range(fluid_bc.group.count[None]):
        ...
        # lb_field.rho[ix,iy,0]=(rho_cr_LB+0.1*ti.random())
